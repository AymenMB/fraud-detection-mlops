...
user.name=AymenMB
user.email=aymen.mabrouk1@hotmail.fr
```
...
# Résultat:
# origin  git@github.com:AymenMB/fraud-detection-mlops.git (fetch)
# origin  git@github.com:AymenMB/fraud-detection-mlops.git (push)
```
...
**Repository GitHub:** https://github.com/AymenMB/fraud-detection-mlops
